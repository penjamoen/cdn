        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (s) {
                var h = this.$element.parent(),
                    ...
                    d = "body" == this.options.container ? 0 : h.offset().left;
...
function(t, e) {
    ...
    function l(e, i, n, o) {
        for (var s, a, r, h = "", c = 0, p = e.length; p > c; ++c) switch (s = e[c], a = s[1], s[0]) {
            case "#":
                if (r = n.lookup(a), "object" == typeof r)
                    if ($(r))
                        for (var f = 0, u = r.length; u > f; ++f) h += l(s[4], i, n.push(r[f]), o);
                    else r && (h += l(s[4], i, n.push(r), o));
    ...
    function f(e, o) {
        ...
        for (var r, l, f, v, b, w = p(o), $ = new s(e), C = [], k = [], x = [], T = !1, E = !1; !$.eos();) {
            if (r = $.pos, f = $.scanUntil(w[0]))
                for (var D = 0, S = f.length; S > D; ++D) v = f.charAt(D), i(v) ? x.push(k.length) : E = !0, k.push(["text", v, r, r + 1]), r += 1, "\n" == v && a();
            if (!$.scan(w[0])) break;
    ...
    s.prototype.eos = function() {
        ...
        return function(n, o) {
            if (o)
                if ("function" == typeof o) i._loadPartial = o;
                else
                    for (var s in o) i.compilePartial(s, o[s]);
...
function(t) {
    ...
    function o() {
        var e, o = "",
            s = t("#video").is(":checked"),
            a = t("#youtubeAutoplay").is(":checked"),
            r = t("#youtubeREL").is(":checked"),
            l = t("#youtubeHD").is(":checked"),
            h = t("#youtubeWidth").val(),
            c = t("#youtubeHeight").val(),
            p = i(t("#youtubeID").val(), s);
        return a && (o += "&amp;autoplay=1"), r && (o += "&amp;rel=0"), l && (o += "&amp;hd=1"), p && (e = n(s, h, c, p + (s ? "" : o))), e
    }

    function s() {
        t("#preview").html(n(!0, 600, 400, i(t("#youtubeID").val())))
    }
    ...
    t(function() {
        var e = {
			...
			youtubeHTML5: parent.tinymce.util.I18n.translate("HTML5 video"),
			youtubeInsertV: parent.tinymce.util.I18n.translate("insert video")
        };
